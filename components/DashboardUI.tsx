        ...
        <div className="min-h-screen bg-[#050b14] text-white font-sans selection:bg-cyan-500/30 overflow-hidden flex flex-col">
            ...
            <footer className="h-16 border-t border-cyan-900/30 bg-[#0a101f] px-6 flex items-center gap-4 relative z-50">
                <div className="flex items-center gap-4 mr-4">
                    ...
                    />
                    <div 
                        className={`w-8 h-8 rounded-full flex items-center justify-center border cursor-pointer transition-all duration-300 group ${
                            isLive 
                ...
                <div className="flex-1 relative h-10 flex items-center group">
                    ...
                    {/* Progress Head */}
                    <div 
                        className={`absolute top-1/2 -translate-y-1/2 w-4 h-4 rounded-full shadow-[0_0_15px_cyan] cursor-grab border-2 border-white z-10 transition-all duration-300 ${
                            isLive ? 'bg-cyan-400' : 'bg-amber-400'
                        }`}
